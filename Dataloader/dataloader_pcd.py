...
class PcdDataset(Dataset):
    def __init__(self, root_dir, valid=False, folder="train", transform=default_transforms(), with_normals=False,nr_views=5,nr_points=512):
...
if __name__ == '__main__':
    ...
    test_dataset = PcdDataset(root,valid=True,folder=folder,nr_views=nr_views,nr_points=nr_points)
